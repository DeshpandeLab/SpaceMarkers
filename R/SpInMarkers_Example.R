...
source('~/FertigLab/Visium/code/find_genes_of_interest_nonparametric_fast.R')
source('~/FertigLab/ProductionCode/SpInMarkers/R/find_genes_of_interest_nonparametric_fast.R')
...
#ATimesP <- CoGAPS_Result@featureLoadings[features,] %*% t(CoGAPS_Result@sampleFactors[barcodes,])
...
SpInMarkers <- getInteractingGenes(data = fullMat, reconstruction = cgMat, spatialPatterns = spPatterns, refPattern = "Pattern_8", mode = "residual")
