...
SpaceMarkers <- getInteractingGenes(data = counts_matrix,
                                    ...
                                    mode ="residual",analysis="analysis")
```
...
```{r}
residual_p1_p2<-SpaceMarkers$interacting_genes[[1]]
DE_p1_p2 <- SpaceMarkers_DE$interacting_genes[[1]]
```
...
ranking in DE mode. APOC1,IGHE,IFI30,CST1,CLU,and CAPG are 
ranked high in both 'DE' and 'residual' mode. While 14 genes that are ranked 
