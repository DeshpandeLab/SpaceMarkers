...
getSpatialParamsExternal. This allows the user to specify the sigma of the
distribution or pull it from the spot diameter on file, which we have found
to be a good estimate. 

```{r}
message("Note that getSpatialParameters is deprecated. 
        Use getSpatialParamsExternal instead.")
optParams <- getSpatialParamsExternal(spPatterns,visiumDir = data_dir,
                                          resolution = "lowres")
```
...
## getSpatialParamsExternal() Arguments
